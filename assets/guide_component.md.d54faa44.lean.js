...
</code></pre></div><h2 id="\u5168\u5C40\u6CE8\u518C"><a class="header-anchor" href="#\u5168\u5C40\u6CE8\u518C" aria-hidden="true">#</a> \u5168\u5C40\u6CE8\u518C</h2><p>\u5982\u679C\u4E0D\u4E60\u60EF\u6309\u9700\u5F15\u5165\u65B9\u5F0F\uFF0C\u53EF\u4EE5\u8FDB\u884C\u5168\u5C40\u6CE8\u518C\u3002\u5168\u5C40\u6CE8\u518C\u4E5F\u5206\u4E24\u79CD\u65B9\u5F0F</p><h3 id="\u5168\u5C40\u6309\u9700\u6CE8\u518C"><a class="header-anchor" href="#\u5168\u5C40\u6309\u9700\u6CE8\u518C" aria-hidden="true">#</a> \u5168\u5C40\u6309\u9700\u6CE8\u518C</h3><p>\u53EA\u6CE8\u518C\u9700\u8981\u7684\u7EC4\u4EF6</p><p>\u4EE3\u7801\u5730\u5740\uFF1A<a href="https://code.99elink.com/wanglei/mingtian-transportation/-/blob/master/src/components/registerGlobComp.ts" target="_blank" rel="noopener noreferrer">src/components/registerGlobComp.ts</a></p><div class="language-ts"><pre><code><span class="token keyword">import</span> <span class="token punctuation">{</span>
...
</code></pre></div>__VP_STATIC_END__`,13),c=[o];function e(u,l,i,k,r,d){return a(),s("div",null,c)}var m=n(p,[["render",e]]);export{f as __pageData,m as default};
